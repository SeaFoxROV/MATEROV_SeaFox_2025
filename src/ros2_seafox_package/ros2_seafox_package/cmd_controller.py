...
class CmdController(Node):
    ...
    def set_thruster_speed_limit(self, request, response):
        self.thrusters_speed_limit[0] = request.front_top_left
        self.thrusters_speed_limit[1] = request.front_top_right
        self.thrusters_speed_limit[2] = request.front_bottom_left
        self.thrusters_speed_limit[3] = request.front_bottom_right
        self.thrusters_speed_limit[4] = request.back_top_left
        self.thrusters_speed_limit[5] = request.back_top_right
        self.thrusters_speed_limit[6] = request.back_bottom_left
        self.thrusters_speed_limit[7] = request.back_bottom_right
        self.get_logger().info('Thruster speed limits updated')
        return response

    def set_max_jerk(self, request, response):
        self.max_jerk = float(request.jerk)
        self.get_logger().info(f'Max jerk set to: {self.max_jerk}')
        return response
