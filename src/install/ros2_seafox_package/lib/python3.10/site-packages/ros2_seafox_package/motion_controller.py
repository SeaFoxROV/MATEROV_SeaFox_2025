...
class MotionController(Node):
    ...
    def joy_callback(self, msg: Joy):
        ...
        left_trigger = msg.data[2]
        right_trigger = msg.data[3]      # Rotation Z
        right_joy_x = msg.data[4]
        right_joy_y = msg.data[5]
        ...
        self.last_user_velocity_command.angular.y = right_joy_x
